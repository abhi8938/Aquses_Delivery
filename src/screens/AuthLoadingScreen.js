      ...
      <View style={{ flex:1, padding:0, justifyContent:'center', alignItems:'center', backgroundColor:'#3490DC'}}>
       <LottieView 
        ...
        <View style={{ width:wp('100%'), paddingTop:hp('5%'), alignItems:'center'}}>
          <Text style ={{ color:'#474646', paddingLeft:wp('2.5%'), fontFamily:'Gotham', fontWeight:'800', fontSize:wp('8%')}}>Aquses <Text style={{ paddingBottom:hp('1%'), fontSize:wp('4%')}}>©</Text></Text>
        </View>
      </View>
    );
  }
